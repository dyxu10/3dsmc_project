...
int main() {
    std::string frame = "00003";
    std::string colorPath = "../data/color/" + frame + ".png";
    std::string depthPath = "../data/depth/" + frame + ".png";
    std::string landmarkPath = "../data/2dlandmarks/" + frame + "_2dlandmarks.txt";

    Matrix3f K = ReadIntrinsics("../data/camera/c00_color_intrinsic.txt");
    MatrixXf flame_lms = LoadLandmarks3D("../data/flame_mediapipe_landmarks.txt");
   ...
   //Landmark3D
    ...
    //save
    std::string filename = "../out/transformed_" + frame + ".off";
